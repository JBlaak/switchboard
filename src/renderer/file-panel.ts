 ...
 *
 * Globals expected: window.api, ViewerPanel,
 *   createMergeViewer, createUnifiedMergeViewer,
 *   createViewerToolbar, openSessions (from app.js)
 */
import { createMergeViewer, createUnifiedMergeViewer } from './codemirror-setup.js';
import { el, terminalArea, terminalsEl } from './dom.js';
import { openSessions, state } from './state.js';
import { ViewerPanel } from './viewer-panel.js';
import type { McpDiffPayload, McpFilePayload } from '../preload/index.js';
import { flashButtonText } from './viewer-toolbar.js';
